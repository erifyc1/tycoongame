...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class PlayerController : MonoBehaviour
    {
        ...
        {
            jumping = context.ReadValue<float>() == 1 && context.started;
        }

        public void OnEsc(InputAction.CallbackContext context)
        {
            escPressed = context.ReadValue<float>() == 1 && context.started;
        ...
        {
            movementSettings.shifting = context.ReadValue<float>() == 1 && context.started;
        }
